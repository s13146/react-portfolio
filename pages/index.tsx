        ...
        <main className="bg-white px-10 dark:bg-gray-900 md:mx-20 md:px-20 lg:px-40">
          <section>
            <nav className="mb-12 flex justify-between py-10 dark:text-white">
              <h1 className="text-md dark:text-white lg:text-2xl">
                Hello, I'm
              </h1>
          ...
          <section>
            <div className="py-8 text-left">
              ...
              <p className="text-sm leading-5 dark:text-white">
                ...
                year). I am a passionate Junior Front-End Developer interested
                in building beautiful, functional and mobile-friendly websites.
                I know the basics of HTML/CSS and JavaScript. Currently learning
                ReactJs. My strong skills are creativity, communication and
                being a team player. I am motivated to learn and ready for new
                challenges.
              </p>
              <Education />
            </div>
          ...
          <section className="md:px-30 justify-between p-5 text-center md:flex">
            <div className="m-5 rounded-xl p-10 shadow-lg dark:bg-white">
